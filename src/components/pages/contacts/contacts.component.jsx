          ...
          >
            ...
            {language === `RU` ? (
              ...
              <div>
                ...
                non-smooth dynamic systems in applications to power electronics,
                electromechanics, theory of automatic control, mathematical
                modeling in endocrinology and mechanics.
                <div>&nbsp;</div>
                <div>E-mail: zhanybai@gmail.com</div>
              </div>
            )}
          ...
          >
            ...
            {language === `RU` ? (
              <div>
                ...
                совета по международной деятельности при Комитете по образованию
                ...
                нелинейной динамике и хаосу, теории бифуркаций и теории
                негладких динамических систем. Это ученые из следующих
                университетов:
                <div>&nbsp;</div>
              ...
              <div>
                ...
                International Education of SWSU, Member of the Expert Council on
                International Activities under the Committee on Education of the
                State Duma. Specialist in the theory of automatic systems
                control, mathematical modeling of mechatronic systems with
                impulse control. Creation of an international scientific
